...
const IndexPage = () => (
  <Layout>
    ...
    <h3>
      ...
      Taking on work on a limited basis. <a href="mailto:js@jordanstephensen.com" target="_blank" rel="noreferrer">Contact me</a> for work samples or to discuss rates.
    </h3><br />
  <Background />
  </Layout>
)
