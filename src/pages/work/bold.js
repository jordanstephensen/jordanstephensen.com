  ...
  <Layout title="Bold Commerce">
    ...
    <div className="contents__container">
      <div className="contents__column--2">
        <big className="text--intro">Bold Commerce is a Winnipeg-based ecommerce company focused on providing merchants of all sizes with flexible and powerful checkout solutions.<br/></big>
      </div>
      <div className="contents__column--2">
        <p>
