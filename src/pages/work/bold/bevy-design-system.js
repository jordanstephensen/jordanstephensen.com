...
const Agoura = () => (
  <Layout title="Bevy Design System">
    ...
    <div className="contents__container">
      <big className="text--intro">Bevy is Bold's design system, a closed-source React library. Beginning in 2022, I led a redesign of Bevy in the context of Bold's rebrand.<br/></big>
    </div>
    <div className="contents__container">
    ...
    <div className="contents__container">
      <img className="contents__column--2" src={brandold} alt="Bold's old brand"/>
      <img className="contents__column--2" src={brandnew} alt="Bold's rebrand"/>
    </div>
...
I did however work on the iconography, illustrations, and design system components shown here.</small>
    ...
    <div className="contents__container">
      <img className="contents__column--2" src={workshops1} alt="Health Icons in use on Alloy Health's website"/>
      <img className="contents__column--2" src={workshops2} alt="Health Icons in use in a presentation at the DHIS2 Conference"/>
    </div>
