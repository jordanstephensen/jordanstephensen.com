...
const HealthIcons = () => (
  <Layout title="Health Icons">
    ...
    <div className="contents__container">
      <img className="contents__container--column" src={use} alt="Health Icons in use on Alloy Health's website"/>
      <img className="contents__container--column" src={conference} alt="Health Icons in use in a presentation at the DHIS2 Conference"/>
    </div>
